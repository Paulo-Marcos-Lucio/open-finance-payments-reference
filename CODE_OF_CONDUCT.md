...
Casos de abuso podem ser reportados ao mantenedor responsável via [Security Advisory privado](https://github.com/Paulo-Marcos-Lucio/open-finance-payments-reference/security/advisories/new) ou e-mail listado no perfil do GitHub.
